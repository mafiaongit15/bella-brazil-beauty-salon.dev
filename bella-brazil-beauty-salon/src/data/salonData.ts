...
export const SALON_LINKS = {
  freshaBooking:
    'https://www.fresha.com/providers/bella-brazil-salon-bf1h5ofv?share=&pId=672441&dppub=true&menu=true',

  onlineStore:
    'https://www.webellabh.com/',

  mapsSaar:
    'https://www.google.com/maps/place/Bella+Brazil+Beauty+Salon,+Saar/data=!4m2!3m1!1s0x3e49b10040772faf:0xdb8ca2e8460a65e3?utm_source=mstt_1&entry=gps&coh=192189',

  mapsSeef:
    'https://www.google.com/maps/place/Bella+Brazil+Beauty+Salon,+Building.+3354,Road.+2845,+Al,+Seef/data=!4m2!3m1!1s0x3e49a55dd1ea1c87:0xe35e214e0c29e067?utm_source=mstt_1&entry=gps&coh=192189',

  instagram:
    'https://www.instagram.com/BELLABRAZILBEAUTYSALON',

  whatsapp:
    'https://wa.me/97333520102',

  tiktok:
    'https://www.tiktok.com/@bellabrazilbeautysalon',

  facebook:
    'https://www.facebook.com/bellabrazilbeautysalon',

  snapchat:
    'https://www.snapchat.com/add/bella_brazilbh'
};
...
export const BRANCHES_DATA: Branch[] = [
  {
    ...
    operatingDays: 'Daily',
    image: image('ig_salon_interior_1790209422670.jpg'),
    googleMapsUrl: SALON_LINKS.mapsSeef,
    description:
      'Our flagship beauty destination situated in the heart of Al Seef. Designed with organic dark jungle palettes, natural travertine textures, and private styling suites for an elevated beauty journey.',
    features: [
      'Private VIP Hair Suites',
      'Full Brazilian Smoothing Bar',
      'Nail Bar & Spa Pedicure Lounge',
  ...
  },
  {
    ...
    operatingDays: 'Daily',
    image: image('salon_saar_boutique_1790208970976.jpg'),
    googleMapsUrl: SALON_LINKS.mapsSaar,
    description:
      'An intimate botanical sanctuary designed for serene hair transformations and unhurried beauty rituals in the peaceful residential enclave of Saar.',
    features: [
      'Botanical Garden Styling Stations',
      'Express Blowdry & Color Bar',
      'Russian Manicure Studio',
      'Dedicated Bridal Consultation Suite'
    ]
  }
];
...
export const SERVICES_DATA: Service[] = [
  {
    ...
    description:
      'The world-renowned professional smoothing treatment. Uses a nutrient-rich Brazilian super-nutrient complex to smooth cuticle layers, eliminate frizz, and impart mirror-like gloss for up to 12 weeks.',
    priceFrom: 70,
    durationMinutes: 120,
    featured: true,
    branchAvailability: ['seef', 'saar'],
    image: image('brazilian_treatment_gloss_1790208564296.jpg'),
    benefits: [
      'Zero frizz even in high Gulf humidity',
      'Retains natural body and bounce',
      'Wash and style immediately with zero downtime'
    ]
  },
  {
    id: 'hair-botox',
    ...
    categoryLabel: 'Brazilian Rituals',
    description:
      'A deep conditioning anti-aging hair repair ritual infused with Brazilian botanical peptides, collagen, and amino acids to plump hollow hair fibers and restore youthful elasticity.',
    priceFrom: 65,
    durationMinutes: 90,
    featured: true,
    branchAvailability: ['seef', 'saar'],
    ...
    benefits: [
      ...
      'Seals split ends with botanical proteins',
      'Provides luminous weightless hydration'
    ]
  },
  {
    id: 'keraorganic',
    ...
    categoryLabel: 'Brazilian Rituals',
    description:
      'An organic, 100% formaldehyde-free smoothing solution powered by Amazonian fruit acids, pracaxi oil, and certified organic plant extracts. Silky discipline with gentle holistic care.',
    priceFrom: 80,
    durationMinutes: 150,
    featured: true,
    branchAvailability: ['seef', 'saar'],
    ...
    benefits: [
      ...
      'Safe for sensitive scalps and expectant mothers',
      'Deep internal fiber realignment'
    ]
  },
  {
    ...
    description:
      'Hand-painted dimensional contouring tailored to your face shape. Blends sun-kissed caramel, honey, and warm chestnut reflections mimicking the effortless warmth of Brazilian shores.',
    priceFrom: 75,
    durationMinutes: 180,
    featured: true,
    branchAvailability: ['seef', 'saar'],
    image: image('editorial_hair_color_1790208584488.jpg'),
    benefits: [
      'Seamless seamless grow-out transition',
      'Custom toning glaze included',
      'Bond-building protection during lift'
    ]
  },
  {
    id: 'roots-color',
    ...
    categoryLabel: 'Color & Light',
    description:
      'Flawless 100% grey coverage and root revitalization with ammonia-reduced European formulations that protect the scalp barrier and seal hair cuticles.',
    priceFrom: 27.5,
    durationMinutes: 60,
    branchAvailability: ['seef', 'saar'],
    image: image('editorial_hair_color_1790208584488.jpg')
  },
  {
    ...
    categoryLabel: 'Color & Light',
    description:
      'An acidic demi-permanent glaze that revitalizes faded highlights, cancels brassy undertones, and locks in high-shine botanical luster.',
    priceFrom: 27.5,
    durationMinutes: 45,
    branchAvailability: ['seef', 'saar'],
    image: image('editorial_hair_color_1790208584488.jpg')
  },
  {
    ...
    description:
      'Consultation-driven precision haircut sculpted to your personal facial architecture, hair density, and daily routine. Includes wash and finished styling.',
    priceFrom: 20,
    durationMinutes: 45,
    branchAvailability: ['seef', 'saar'],
    image: image('hero_brazilian_beauty_1790208553834.jpg')
  },
  {
    ...
    categoryLabel: 'Hair Design',
    description:
      'Full-bodied Brazilian blowout styling using ceramic round brushes and thermal protective rainforest elixirs for bouncy movement that lasts days.',
    priceFrom: 12,
    durationMinutes: 45,
    branchAvailability: ['seef', 'saar'],
    image: image('hero_brazilian_beauty_1790208553834.jpg')
  },
  {
    ...
    description:
      'Dry e-file precision cuticle detailing followed by strengthening BIAB base coat and high-gloss gel lacquer with flawless under-cuticle application.',
    priceFrom: 24,
    durationMinutes: 75,
    featured: true,
    branchAvailability: ['seef', 'saar'],
    image: image('salon_interior_luxury_1790208575500.jpg')
  },
  {
    ...
    categoryLabel: 'Nails & Hands',
    description:
      'Exfoliating Amazonian sugar scrub, calluses treatment, warm botanical oil massage, and lasting gel polish finish in our ergonomic spa loungers.',
    priceFrom: 28,
    durationMinutes: 60,
    branchAvailability: ['seef', 'saar'],
    image: image('salon_interior_luxury_1790208575500.jpg')
  },
  {
    ...
    description:
      'Comprehensive VIP bridal experience including full bridal hair trial, wedding day architectural updo, luxury long-wear makeup, and bridal party pampering.',
    priceFrom: 150,
    durationMinutes: 240,
    featured: true,
    branchAvailability: ['seef', 'saar'],
    image: image('bridal_beauty_glamour_1790208593187.jpg'),
    benefits: [
      'Dedicated private bridal suite',
      'Pre-wedding skin & hair timeline',
      'Complimentary veil and hair jewelry placement'
    ]
  },
  {
    ...
    description:
      'Multi-step clinical facial featuring gentle ultrasonic exfoliation, lymphatic facial drainage massage, and high-potency vitamin C botanical infusion.',
    priceFrom: 45,
    durationMinutes: 60,
...
export const PRODUCTS_DATA: Product[] = [
  {
    ...
    description:
      'Patented K18Peptide formula that reverses damage from bleach, color, chemical services, and heat in just 4 minutes.',
    volume: '50ml',
    price: 32,
    stock: 18,
    image: image('brazilian_treatment_gloss_1790208564296.jpg'),
  ...
  },
  {
    ...
    category: 'Dry Hair',
    description:
      'Formulated with up to 99% natural origin ingredients. Gently cleanses and restores hair vitality without stripping moisture.',
    volume: '250ml',
    price: 14.5,
    stock: 24,
    image: image('brazilian_treatment_gloss_1790208564296.jpg'),
  ...
  },
  {
    ...
    description:
      'Enriched with organic certified Argan and Linseed oil to eliminate frizz, seal split ends, and add radiant shine without greasy weight.',
    volume: '100ml',
    price: 26,
    stock: 12,
    image: image('brazilian_treatment_gloss_1790208564296.jpg'),
  ...
  },
  {
    ...
    description:
      'Shields colored hair from fading, keeps pigments locked deep inside cuticles, and provides instantaneous silky softness.',
    volume: '200ml',
    price: 16,
    stock: 15,
    image: image('editorial_hair_color_1790208584488.jpg'),
  ...
  },
  {
    ...
    description:
      'Flexible bristles effortlessly glide through wet or dry hair without snagging or pulling sensitive Brazilian-treated hair.',
    volume: '1 Unit',
    price: 11,
    stock: 30,
    image: image('salon_interior_luxury_1790208575500.jpg'),
  ...
  },
  {
    ...
    description:
      'Our proprietary salon finish oil containing cold-pressed Brazilian Pracaxi oil for unmatched shine, thermal defense, and humid-proof discipline.',
    volume: '60ml',
    price: 22.5,
    stock: 40,
    image: image('brazilian_treatment_gloss_1790208564296.jpg'),
...
export const ARTICLES_DATA: Article[] = [
  {
    ...
    excerpt:
      'From organic smoothing botanicals to fiber-rebuilding botox, understand why Brazilian haircare has become the gold standard in Bahrain.',
    readTime: '4 min read',
    date: 'September 2026',
  ...
  },
  {
    ...
    category: 'Color & Care',
    excerpt:
      'Bespoke advice on protecting blonde tones, neutralizing brassiness, and keeping hair cuticles hydrated during hot months.',
    readTime: '5 min read',
    date: 'August 2026',
  ...
  },
  {
    ...
    excerpt:
      'How precision dry e-file cuticle techniques result in four weeks of immaculate, clean nail growth.',
    readTime: '3 min read',
    date: 'July 2026',
...
export const REVIEWS_DATA: Review[] = [
  {
    ...
    comment:
      'The best hair treatment in Bahrain by far. My curls were completely unmanageable in the summer humidity until Camila worked her magic. Zero frizz, mirror shine, and so soft.',
    date: '2 weeks ago'
  },
  {
    id: 'rev-2',
    ...
    comment:
      'The aesthetic of the Saar branch feels like a secluded botanical sanctuary. Gabriela achieved the exact caramel blend I asked for without any breakage. Truly exceptional artistry.',
    date: '1 month ago'
  },
  {
    id: 'rev-3',
    ...
    verifiedSource: 'Fresha Verified Booking',
    comment:
      'Impeccable hygiene and meticulous attention to detail. My Russian manicure lasted a full month without a single lift. Bella Brazil is in a class of its own.',
    date: '3 weeks ago'
  }
];
